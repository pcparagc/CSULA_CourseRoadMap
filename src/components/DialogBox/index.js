        ...
        <div>
          ...
          <DialogContent dividers>
            ...
            <Typography style={{ paddingBottom: "20px" }}>
              Transcendental functions, polar functions, sequences, infinite
              series and methods of integration. Further exposure to techniques
              and applications of differential and integral calculus. C-ID: MATH
              221
            </Typography>
          ...
          <Typography
            ...
            style={{ padding: "16px" }}
          >
            Contact your academic advisor for any questions regarding
            prerequisites
          </Typography>
        </div>
      )}
